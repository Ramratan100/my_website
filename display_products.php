...
// Fetch products
$sql = "SELECT Products.product_id, Products.name, Products.description, Products.price, Categories.category_name
        FROM Products
    ...
    <div class="products-container">
        ...
        if ($result->rowCount() > 0) {
            ...
            while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
                ...
                echo '<img src="product-placeholder.jpg" alt="Product Image" class="product-image">';  // Placeholder image
